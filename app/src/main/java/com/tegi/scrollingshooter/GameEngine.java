...
class GameEngine extends SurfaceView implements Runnable,GameStarter,GameEngineBroadcaster,PlayerLaserSpawner,AlienLaserSpawner {
    ...
    public GameEngine(Context context,Point size){
        ...
        mParticleSystem.init(20);
        mPhsycsEngine = new PhysicsEngine();
    ...
    public void run(){
        while (mGameState.getThreadRunning()){
            ...
            if (!mGameState.getPaused()){
                ...
                if (mPhsycsEngine.update(mFPS,objects,mGameState,mSoundEngine,mParticleSystem)){
                    //player hit
                    deSpawnReSpawn();
                }
            }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent){
        ...
        //the next line is temporery code to emit a particle system
        //mPaticleSystem.emitParticles(new PointF(500,500));
        return true;
    }
